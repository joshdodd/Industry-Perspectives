<?php
	...
	**/
	...
	function display_latest_tweets(
		...
		$date_format         = 'M j',    // Date formatting. (http://php.net/manual/en/function.date.php)
		...
		$consumerkey         = "ONqVm84DLVoRujODmEEsOw";
		$consumersecret      = "mdiiLD2coaIlixsYEMBwmfPNMSR634hg5rAORDEKcc";
		$accesstoken         = "335369709-DHn6Nzg3g1vQqo3SdlnfckZTf1fUxU0l14NCAbbK";
		$accesstokensecret   = "Z4YSGuj3fqRngcEF7RczU0ezJ0yCv1S83KiWNkCoUo";
				...
				if (count($get_tweets)) {
					...
					foreach($get_tweets as $tweet) {
						...
						if ($ignore_replies==false){
							...
							$show_tweet = '<li>' . $tweet_desc . ' <time>'.$display_time.'</time></li>';
							//$show_tweet = str_replace("'","\'",$show_tweet);
							
							/*print '<div class="row tweet-items">';
							print '<div class="contentBox"><div>';
							print '<span class="icon-twitter"></span>';*/
							print $show_tweet;
							/*print '</div></div>';
							print '</div>' . "\n\n";*/
						}
	...
	display_latest_tweets('APICIPIPC');
?>
